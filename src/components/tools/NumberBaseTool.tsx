    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-4 sm:mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
          <Binary className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />
          进制转换
        </h1>
      ...
      <div className="card p-4 sm:p-6 space-y-4">
            ...
            >
              <div className="flex items-center gap-3 p-3">
                <label
                  ...
                  className="w-16 sm:w-20 text-sm font-medium text-gray-700 dark:text-gray-300 shrink-0"
                >
                  {config.name}
                </label>
              ...
              {config.prefix && (
                <div className="absolute right-14 bottom-1 text-[10px] text-gray-400 dark:text-gray-600 pointer-events-none">
                  前缀: {config.prefix}
                </div>
              )}
            </div>
        ...
        {/* 提示信息 */}
        <div className="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-slate-800/50 rounded-lg p-3">
      ...
      <div className="card p-4 sm:p-6 mt-4">
        <h2 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white mb-4">
          常用数值对照表
        </h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-slate-700">
                <th className="text-left py-2 px-3 font-medium text-gray-700 dark:text-gray-300">十进制</th>
                <th className="text-left py-2 px-3 font-medium text-gray-700 dark:text-gray-300">二进制</th>
                <th className="text-left py-2 px-3 font-medium text-gray-700 dark:text-gray-300">八进制</th>
                <th className="text-left py-2 px-3 font-medium text-gray-700 dark:text-gray-300">十六进制</th>
              </tr>
            </thead>
