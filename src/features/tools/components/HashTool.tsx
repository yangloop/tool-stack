      ...
      <div className="card p-4 sm:p-6 mb-4 space-y-3 sm:space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 sm:px-4 py-2 font-mono text-xs sm:text-sm bg-surface-50 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg focus:ring-2 focus:ring-primary-500 dark:text-surface-100"
          />
        </div>
      </div>
