          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {parsedDDL && schemas.length > 0 && (
                <span className="text-xs px-2 py-0.5 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300 rounded-full">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {result.sql && (
                      <div className="mt-2 p-2 bg-surface-100 dark:bg-surface-800 rounded text-xs font-mono text-surface-600 dark:text-surface-400 overflow-x-auto">
                        {result.sql}
                      </div>
                    )}
                    {result.details && result.details.length > 0 && (
                      <ul className="mt-2 space-y-1">
                        {result.details.map((detail, idx) => (
                          <li key={idx} className="text-xs text-surface-500 dark:text-surface-400 flex items-start gap-1">
