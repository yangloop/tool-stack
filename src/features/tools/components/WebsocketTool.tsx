...
export function WebsocketTool() {
  ...
  const sendMessage = useCallback(() => {
    ...
    try {
      ...
      addMessage('system', '消息发送失败: JSON 格式错误');
    }
    ...
    <div className="max-w-6xl mx-auto animate-fade-in">
      ...
      <div className="card p-2.5 sm:p-4 mb-4 sm:mb-5 space-y-4">
        ...
        <div className="border border-surface-200 dark:border-surface-700 rounded-xl overflow-hidden">
          ...
          {showSettings && (
            <div className="p-3 sm:p-4 space-y-4 border-t border-surface-200 dark:border-surface-700">
      ...
      <div className="grid lg:grid-cols-3 gap-2.5 sm:p-3 sm:p-4 sm:gap-5">
        ...
        <div className="lg:col-span-2">
          <div className="card h-full flex flex-col">
            ...
            {/* 消息列表 */}
            <div className="flex-1 min-h-[300px] sm:min-h-[400px] max-h-[500px] sm:max-h-[600px] overflow-y-auto bg-surface-50 dark:bg-surface-900/30 rounded-xl border border-surface-200 dark:border-surface-700 p-3 space-y-2">
              {messages.length === 0 ? (
                  ...
                  >
                    <div className="flex items-center justify-between mb-1.5">
                      <div className="flex items-center gap-1.5">
                        {message.type === 'sent' ? (
                          <>
                            <span className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-primary-500 flex items-center justify-center">
                          ...
                          <>
                            <span className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-surface-400 flex items-center justify-center">
