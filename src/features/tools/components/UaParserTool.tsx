  ...
  return (
    <div className={`p-4 rounded-xl border ${colorClasses[color]}`}>
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="font-semibold text-surface-900 dark:text-surface-100">{title}</span>
      </div>
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {parsed && (
        <>
          ...
          {/* 浏览器特性 */}
          <div className="card">
            <h3 className="font-medium text-surface-900 dark:text-surface-100 mb-3 flex items-center gap-1.5 sm:gap-2">
          ...
          <div className="card">
            ...
            >
              <span className="font-medium text-surface-900 dark:text-surface-100">原始 User Agent</span>
              {showRaw ? (
                <ChevronUp className="w-4 h-4 sm:w-5 sm:h-5 text-surface-400" />
              ) : (
                <ChevronDown className="w-4 h-4 sm:w-5 sm:h-5 text-surface-400" />
              )}
            </button>
            {showRaw && (
              <div className="mt-3 p-3 bg-surface-50 dark:bg-surface-900 rounded-lg">
                <code className="text-xs font-mono text-surface-700 dark:text-surface-300 break-all">
                  {ua}
                </code>
              </div>
            )}
      ...
      {/* 提示信息 */}
      <div className="p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg text-sm text-primary-700 dark:text-primary-400">
