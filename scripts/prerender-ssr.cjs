...
function generateSeoMeta(config, toolUrl) {
  ...
  const metaTags = `
    ...
    <meta name="ai-content-type" content="tool" />
    <meta name="ai-purpose" content="developer utilities" />
    <meta name="copyright" content="ToolStack" />
...
${JSON.stringify(finalJsonLd, null, 2)}
  ...
  return { metaTags, pageTitle, pageDesc, keywords };
}
...
const homeKeywords = '开发者工具,在线工具,JSON格式化,SQL格式化,Base64编解码,哈希计算,RSA加密,二维码生成';
...
const homeMetaTags = `
    ...
    <meta property="og:description" content="ToolStack 是现代化开发者工具集合，包含25+实用工具：JSON/SQL格式化、Base64编解码、哈希计算等。界面简洁，支持深色模式。" />
    <meta property="og:url" content="${domain}/" />
    <meta property="og:image" content="${domain}/og-image.png" />
    <meta property="og:locale" content="zh_CN" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="ToolStack - 开发者在线工具箱 | 25+实用工具集合" />
    <meta name="twitter:description" content="ToolStack 是现代化开发者工具集合，包含25+实用工具：JSON/SQL格式化、Base64编解码等。界面简洁，支持深色模式。" />
    <meta name="twitter:image" content="${domain}/og-image.png" />
    <script type="application/ld+json">
...
// 插入首页 SEO Meta 标签
homeHtml = homeHtml.replace('</head>', `${homeMetaTags}\n  </head>`);
